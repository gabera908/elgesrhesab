"""Deploy: upload latest code bundle and rebuild backend+frontend on the LAN server."""
import os
import tarfile
import tempfile
import paramiko
...
EXCLUDE_DIRS = {".git", "node_modules", "__pycache__", ".venv", "venv", "dist", ".pytest_cache"}
EXCLUDE_FILES = {"__deploy.py"}
